...
然后添加一个触发按钮`workflow_dispatch`用于调试  [如图](https://github.com/git-yusteven/openit/blob/main/.github/说明文档.md#调试时点击绿框直接运行-返回)
#### 具体实现
...
##### 调试时，点击绿框直接运行 [返回到CDN](https://github.com/git-yusteven/openit/blob/main/.github/说明文档.md#cdn具体实现) [返回到Base64 Encode](https://github.com/git-yusteven/openit/tree/main/.github#base64-encode-具体实现)

...
## iOS
首推Shadowrocket,Quantumult,Surge,Potatso 2（尽管是付费的）圈x和Surge是面向专业发烧友的，特别是Surge提供更多扩展功能而Postato 2偏小众。购买时必须使用外区Apple ID下载(首推美区)；当然也有为广大白嫖用户准备的Potatso(只支持ss协议)；Onechick(支持ss,Trojan,Vmess，小众良心软件)；Shadowlink(**安全性存疑**，支持ss,Trojan,Vmess)
### Shadowrocket $2.99

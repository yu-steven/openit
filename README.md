...
以下软件下载由知名[**CDN**](https://www.huaweicloud.com/zhishi/edit-590710.html)--->[**jsdelivr**](https://www.jsdelivr.com/)进行加速，提高用户访问文件的响应速度和下载速度，使用时不需要代理；这里给出[**jsdelivr**转换地址](https://www.jsdelivr.com/github)
## Windows

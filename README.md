...
## macOS
首推[Clash](https://github.com/git-yusteven/openit#clash)，稳定通用，但需要订阅转换！[ClashX](https://github.com/git-yusteven/openit#clashx)和[Clash](https://github.com/git-yusteven/openit#clash)一样内核，前者更加轻量化，当然，M1芯片可以使用Clash(Arm)&iPhone/iPad版的Shadowrocket *$2.99*

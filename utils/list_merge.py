...
class sub_merge():
    def sub_merge(url_list): # 将转换后的所有 Url 链接内容合并转换 YAML or Base64, ，并输出文件，输入订阅列表。
        ...
        content_yaml = sub_convert.convert(content_all,'content','YAML',{'dup_rm_enabled': False, 'format_name_enabled': True, 'speedtest': False})
        ...
        write_list = [f'{sub_merge_path}/url', f'{sub_merge_path}/base64', f'{sub_merge_path}/clash']
